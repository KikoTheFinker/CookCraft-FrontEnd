    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.socialLinks}>
          <a href="#" className={`${styles.socialContainer} ${styles.instagramContainer}`}>
          ...
          <a href="#" className={`${styles.socialContainer} ${styles.twitterContainer}`}>
          ...
          <a href="#" className={`${styles.socialContainer} ${styles.linkedinContainer}`}>
