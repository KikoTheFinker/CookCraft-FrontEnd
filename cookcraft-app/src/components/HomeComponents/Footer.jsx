...
import styles from "../../css/HomeCss/footer.module.css"; 
function Footer() {
  return (
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.socialLinks}>
          <a href="instagram.com" className={`${styles.socialContainer} ${styles.instagramContainer}`}>
          ...
          <a href="twitter.com" className={`${styles.socialContainer} ${styles.twitterContainer}`}>
          ...
          <a href="linkedin.com" className={`${styles.socialContainer} ${styles.linkedinContainer}`}>
